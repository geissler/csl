...
class LayoutTest extends \PHPUnit_Framework_TestCase
{
    ...
    [
        ...
        $this->assertContains('(1, 2)', $this->object->render(''));
    }
    ...
    [
        ...
        $this->initElement($layout, $json, $citation);
        $this->assertContains('Roe; Doe', $this->object->render(''));
    }
    ...
    [
        ...
        $this->initElement($layout, $json, $citation);
        $this->assertContains('(As written in Smith 2000)', $this->object->render(''));
    }
