...
class YearTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testModifyAndRender()
    {
        $layout =   '<date-part name="year" form="short"/>';
        $this->initElement($layout);
        $xml    =   new \SimpleXMLElement('<date-part name="year" form="long"/>');
        $this->assertInstanceOf('\Geissler\CSL\Date\Year', $this->object->modify($xml));
        $this->assertEquals('1999', $this->object->render('1999'));
    }
